...
from analisi_md_paroxetina import gyration_wt, gyration_k
...
def plot_gyration(num, x, y, labels, colors, ylim, figure_name):
    ...
    for i in range(0, num):
        ax.plot(x[i], y[i], color=colors[i], alpha=0.6, label=labels[i], linewidth=2)
...
def plot_kde_dihedrals_seaborn(data1, data2, gyr_wt, gyr_k, figname):
    ...
    df_wt_k = pd.concat([df_wt, df_k], ignore_index=True)
    df_wt_k['Variant'] = np.repeat(['wt', 'K141E'], [int(len(data1)), int(len(data2))])
...
t_wt_parox, gyr_wt_parox = read_gyration_data("gyrate_wt_paroxetine_all.xvg")
...
gyration_runavg_wt_paroxetine = [gyr_wt_7_parox_runavg, gyr_wt_8_parox_runavg, gyr_wt_9_parox_runavg,
                                 gyr_wt_10_parox_runavg, gyr_wt_11_parox_runavg, gyr_wt_12_parox_runavg,
                                 gyr_wt_13_parox_runavg, gyr_wt_14_parox_runavg, gyr_wt_15_parox_runavg,
                                 gyr_wt_16_parox_runavg, gyr_wt_17_parox_runavg, gyr_wt_18_parox_runavg,
                                 gyr_wt_19_parox_runavg]
...
# PLOT RG TIMELINE
labels_gyration_comparison_wt = ['wt 7', 'wt 8', 'wt 9', 'wt 10', 'wt 11', 'wt 12', 'wt 13', 'wt 14', 'wt 15', 'wt 16',
                                 'wt 17', 'wt 18', 'wt 19']
labels_gyration_comparison_k = ['K141E 1', 'K141E 2', 'K141E 3', 'K141E 4', 'K141E 5', 'K141E 6', 'K141E 20',
                                'K141E 21', 'K141E 22']
colors_wt = ['blue', 'orange', 'green', 'red', 'cyan', 'purple', 'magenta', 'black', 'yellow', 'pink', 'lime', 'violet',
             'coral']

# plot_gyration(13, time_runavg_wt_paroxetine, gyration_runavg_wt_paroxetine, labels_gyration_comparison_wt, colors_wt,
#               [1.7, 3.3], figure_name='gyration_timeline_wt_paroxetine_all')
...
###########
# DIHEDRALS
time_wt_paroxetine, dihedral_91_94_wt_paroxetine = read_dihedral_data("dihedrals_91_94_wt_paroxetine_all.dat")
